export default function NotFound() {
  return (
    <div style={{
      ...
      <p style={{ fontSize: 16, color: '#9A8F88', maxWidth: 360, marginBottom: 32, lineHeight: 1.6 }}>
        This song may have expired or the link is incorrect. Songs are stored for 30 days after creation.
      </p>
      <a href="/" style={{
